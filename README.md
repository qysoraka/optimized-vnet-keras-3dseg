...
- `_t2.nii.gz`
- `_seg.nii.gz` (label)
The label file with `_seg.nii.gz` should have only 0, 1, 2, 4 as its value, corresponding to the BraTS 2018 brain tumor segmentation data [https://www.med.upenn.edu/sbia/brat